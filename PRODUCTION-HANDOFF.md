...
5. ใส่แถวปีว่างสำหรับนโยบายทั่วไป และแถวระบุปีเฉพาะเมื่อมี effective-period exception
...
8. ตรวจรายการ `LeaveBalances` โดยเฉพาะยอดยกมาและยอดใช้ก่อนเริ่มระบบ
9. เมื่อ HR ตรวจครบจริง ให้ตั้ง Settings `leave_policy_reviewed_at` เป็นวันที่ ค.ศ. รูปแบบ `YYYY-MM-DD`
10. โหลดหน้า **ภาพรวม** และยืนยันว่าไม่มีคำเตือน policy review
...
- ตรวจใบข้ามปีถูกปฏิเสธ
- ตรวจ quota เฉพาะปีทับค่า default ถูกต้อง
