...
function setupSheet() {
  ...
  [
    ...
    ['admin_staff', '', 'รายชื่อผู้ดูแลระบบ — ชื่อต้นคั่นลูกน้ำ (เช่น สมชาย, สมหญิง): ใครอยู่ในรายชื่อและผูก LINE กับทำเนียบแล้ว ล็อกอินหน้าผู้ดูแลด้วย LINE ได้ · เว้นว่าง = ใช้รหัส ADMIN_TOKEN อย่างเดียว (แก้ได้จากหน้าเว็บผู้ดูแล > ตั้งค่าระบบ)'],
  ].forEach(row => {
