...
function setupSheet() {
  ...
  [
    ...
    ['photo_managers', '', 'ผู้จัดการคลังภาพ — รายชื่อ "ชื่อ สกุล" ของเจ้าหน้าที่ที่มีสิทธิ์จัดการ Inbox/ย้าย/เปลี่ยนชื่อ/จัดเก็บภาพ คั่นลูกน้ำ · ไม่เกี่ยวกับผู้อนุมัติใบลา · ผู้ที่อยู่ใน admin_staff ได้สิทธิ์ admin สูงกว่าโดยอัตโนมัติ'],
  ].forEach(row => {
