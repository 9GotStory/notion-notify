...
// ลากิจ: ระเบียบ สนง.นายกฯ 2559 ไม่จำกัดวันลา แต่ได้รับเงินเดือนระหว่างลาไม่เกิน 45 วันทำการ/ปี → เตือนที่ 45
// ลาพักร้อนตามระเบียบสะสมได้ไม่เกิน 2 ปี รวมต่อครั้งไม่เกิน 45 วันทำการ จึงเตือนเป็นรายกรณีแทนการล็อกตัวเลข
// (ค่านี้เป็นค่าทั่วไปเมื่อไม่ระบุประเภทบุคลากร — ต่อให้ระบุแล้วใช้ QUOTA_PROFILE_SEED ด้านล่างแทน)
const LEAVE_QUOTAS = {
  'ลากิจ': 45,
  'ลาพักร้อน': 10,
  'ลาคลอด': 90,
...
// ข้อมูลสิทธิ์วันลาอ้างอิงตามระเบียบ/ประกาศ (หน่วย: วันทำการ/ปี) — ใช้เป็นข้อมูลตั้งต้นของชีต QuotaProfiles
// ศึกษาเมื่อ ส.ค. 2569 จากแหล่งทางการ และตรวจสอบข้ามแหล่งแล้ว (กรมควบคุมโรค/สำนักงาน ก.พ./มหาดไทย/โรงพยาบาลในสังกัด สธ.)
// ตัวเลข = เกณฑ์ "ได้รับเงินเดือน/ค่าจ้าง" (จุดที่ควรเตือน) ส่วนเงื่อนไขพิเศษ (ปีแรก/วันสะสม/พระบรมราชานุญาต) อยู่ในหมายเหตุ
...
const QUOTA_PROFILE_SEED = [
  ...
  ['', 'ข้าราชการ', 'ลาอุปสมบถ/ลาบวช', 120, 'ลาได้ไม่เกิน 120 วัน ต้องรับราชการมาแล้วไม่น้อยกว่า 12 เดือน'],
  ...
  // พนักงานราชการ — ประกาศคณะกรรมการบริหารพนักงานราชการ เรื่อง สิทธิประโยชน์ของพนักงานราชการ พ.ศ. 2554 และฉบับที่ 2 (การสะสมวันลาพักผ่อน)
  ...
  ['', 'พนักงานราชการ', 'ลาอุปสมบถ/ลาบวช', 120, 'ลาได้ไม่เกิน 120 วัน ต้องได้รับการจ้างต่อเนื่องมาแล้ว ≥4 ปี ลาได้ 1 ครั้งตลอดสถานภาพ'],
  ['', 'พนักงานราชการ', 'ลาช่วยเหลือภริยาคลอดบุตร', 0, 'ประกาศไม่ระบุให้ได้รับสิทธิแบบข้าราชการ — ปรับได้ตามนโยบายหน่วยงาน'],
  ...
  ['', 'พนักงานกระทรวงสาธารณสุข', 'ลาอุปสมบถ/ลาบวช', 0, 'ประกาศ ก.บริหาร พกส. ไม่ระบุสิทธิลาอุปสมบท — ปรับได้ตามนโยบายหน่วยงาน'],
  ...
  ['', 'ลูกจ้างประจำ', 'ลาอุปสมบถ/ลาบวช', 120, 'อนุโลมตามระเบียบการลาของข้าราชการ — ทำงานมาแล้ว ≥12 เดือน จึงลาได้'],
  ['', 'ลูกจ้างประจำ', 'ลาช่วยเหลือภริยาคลอดบุตร', 0, 'ระเบียบ ก.คลัง ไม่ระบุสิทธินี้ — ปรับได้ตามนโยบายหน่วยงาน'],
  ...
  ['', 'ลูกจ้างชั่วคราวรายเดือน', 'ลาอุปสมบถ/ลาบวช', 0, 'ไม่มีสิทธิตามระเบียบ — หากหน่วยงานอนุญาต ปรับได้'],
  ['', 'ลูกจ้างชั่วคราวรายเดือน', 'ลาช่วยเหลือภริยาคลอดบุตร', 0, 'ไม่มีสิทธิตามระเบียบ'],
  ...
  ['', 'ลูกจ้างรายวัน', 'ลาอุปสมบถ/ลาบวช', 0, 'ไม่มีสิทธิตามระเบียบ — หากหน่วยงานอนุญาต ปรับได้'],
  ['', 'ลูกจ้างรายวัน', 'ลาช่วยเหลือภริยาคลอดบุตร', 0, 'ไม่มีสิทธิตามระเบียบ'],
];
