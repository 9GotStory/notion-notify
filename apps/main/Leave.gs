...
const LEAVE_TYPES_DEFAULT = [
  ...
  'ลาอุปสมบท/ลาบวช', 'ลาช่วยเหลือภริยาคลอดบุตร', 'อื่นๆ',
];
...
const MANUAL_REVIEW_QUOTA_TYPES = [
  'ลาคลอด', 'ลาอุปสมบท/ลาบวช', 'ลาช่วยเหลือภริยาคลอดบุตร',
];
...
const QUOTA_PROFILE_SHEET_TITLE = 'โควตาสิทธิ์ตามประเภทบุคลากร (ว่างทั้งชีต = ทุกคนใช้ค่าเริ่มต้นตามระเบียบราชการ)';
...
const QUOTA_PROFILE_SEED = [
  ...
  ['', 'ข้าราชการ', 'ลาช่วยเหลือภริยาคลอดบุตร', 15, 'ไม่เกิน 15 วันทำการ ต้องขอภายใน 90 วันนับแต่วันที่ภริยาคลอดบุตร ได้รับเงินเดือนระหว่างลา'],
  ...
  ['', 'พนักงานราชการ', 'ลาช่วยเหลือภริยาคลอดบุตร', 15, 'ไม่เกิน 15 วันทำการติดต่อกัน ต้องลาภายใน 90 วันนับแต่วันที่ภริยาโดยชอบด้วยกฎหมายคลอดบุตร (ประกาศสิทธิประโยชน์ ฉบับที่ 4 พ.ศ. 2566)'],
  ...
  ['', 'พนักงานกระทรวงสาธารณสุข', 'ลาช่วยเหลือภริยาคลอดบุตร', 15, 'ลาได้ 15 วันทำการต่อการคลอดบุตร 1 ครั้ง โดยได้รับค่าจ้างระหว่างลา'],
  ...
  ['', 'ลูกจ้างประจำ', 'ลาช่วยเหลือภริยาคลอดบุตร', 15, 'ไม่เกิน 15 วันทำการ; การได้รับค่าจ้างให้ตรวจเงื่อนไขตามระเบียบการจ่ายค่าจ้างและวันที่ยื่นลา'],
  ...
  ['', 'ลูกจ้างชั่วคราวรายเดือน', 'ลาช่วยเหลือภริยาคลอดบุตร', 15, 'ลาได้ไม่เกิน 15 วันทำการ; สิทธิค่าจ้างขึ้นกับสัญญาและกฎหมายปัจจุบัน ให้ HR ยืนยันก่อนใช้จริง'],
  ...
  ['', 'ลูกจ้างรายวัน', 'ลาช่วยเหลือภริยาคลอดบุตร', 15, 'ลาได้ไม่เกิน 15 วันทำการ; สิทธิค่าจ้างขึ้นกับสัญญาและกฎหมายปัจจุบัน ให้ HR ยืนยันก่อนใช้จริง'],
];
...
function readLeaveBalances_() {
  ...
  data.forEach((row, i) => {
    ...
    if (!(yearBE >= 2500 && yearBE <= 2600) || !name || !leaveType ||
